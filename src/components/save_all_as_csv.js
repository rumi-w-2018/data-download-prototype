...
class SaveAllAsCsv extends Component {
    ...
    fetch(e) {
        ...
        .done( response => {
            if(response.length>0){
                ...
                const filename = 'product_list_' + Moment().format('YYYYMMDD_HHmmss') + '.csv';
                ...
                console.log('Error!', 'Error occurred while processing CSV file.');
                this.setState({
                    showMsgModal: false,
                    msgHeader: 'Errir',
                    msgContents: 'Error occurred while processing CSV file.',
                    msgShowLoadingIcon: true,
        ...
        return (
            <span>
                <button className="btn btn-sm btn-info" onClick={this.toggleDialog.bind(this)}
                        style={{fontSize:'1em', height:'2em', padding:'1px 10px', marginRight:'4px', marginTop: '-5px'}}>Export As CSV</button>
                                ...
                                <div className="modal-content bg-light">
                                    <div className="modal-body">
                                        ...
                                        <p>You are requesting <span style={{fontWeight:'bold', color:'#f89406'}}>{this.props.fetchedProducts.total}</span> items
                                            in CSV format. Are you sure you want to proceed?</p>
...
export default connect( mapStateToProps, mapDispatcherToProps )(SaveAllAsCsv);
